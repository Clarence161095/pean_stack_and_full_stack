...
To build the final jar and optimize the noteApp application for production, run:
...
[Doing API-First development]: https://www.jhipster.tech/documentation-archive/v8.2.1/doing-api-first-development/
