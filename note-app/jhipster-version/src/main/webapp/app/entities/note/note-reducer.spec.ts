...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './note.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NOTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NOTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NOTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NOTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NOTE actions', async () => {
      const arg = 42666;
