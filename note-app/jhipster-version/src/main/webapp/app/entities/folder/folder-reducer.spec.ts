...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './folder.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOLDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FOLDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FOLDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FOLDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FOLDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FOLDER actions', async () => {
      const arg = 42666;
