  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="noteAppJaApp.folder.home.createOrEditLabel" data-cy="FolderCreateUpdateHeading">
            <Translate contentKey="noteAppJaApp.folder.home.createOrEditLabel">Create or edit a Folder</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('noteAppJaApp.folder.name')}
                id="folder-name"
                name="name"
                data-cy="name"
                type="text"
